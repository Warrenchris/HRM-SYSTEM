...
import { PiggyBank, Users, DollarSign, TrendingUp, Banknote, Target } from "lucide-react";

export function WelfareStats() {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">$13,569</div>
          <p className="text-xs text-muted-foreground">
